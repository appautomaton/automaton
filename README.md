...
[![site](https://github.com/appautomaton/automaton/actions/workflows/pages.yml/badge.svg)](https://appautomaton.com/automaton/)
...
- [Site](https://appautomaton.com/automaton/): the operating model in one scroll
